<template>
  <div>
    ...
    <div class="text-right mt-4">
      ...
      <!-- pagination -->
      <Page :pagination="pagination" @getList="getList" />
                ...
                <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    <label for="customFile">
                      或 上傳圖片
                      <font-awesome-icon icon="spinner" v-if="status.fileUploading" />
                    </label>
                    <input
                      type="file"
                      id="customFile"
...
export default {
  ...
  methods: {
    ...
    uploadFile() {
      ...
      formData.append("file-to-upload", uploadedFile); // <input type="file" name="file-to-upload">
